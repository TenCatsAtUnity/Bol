# Template steps to making a new project

1. ##### Use `com.unity.template.starter-kit` to create a new template repo
...
5. ##### create yamato set dev as default branch

6. ##### create slack notifcation from yamato

7. ##### give unity all read access to template in git

8. ##### Give template team Engineers Nic Vidil, Nick Maggio, and Vicky Voinova admin access

9. ##### make a dev branch and it to be the default branch in git
...
1. ##### Open your cloned project and develop!
    ...
    Start **Unity**, open your template project folder. Once opened, you can modify the project settings, the project assets and even the packages dependencies to suit your needs. Your project template will contain all the content of your project.
